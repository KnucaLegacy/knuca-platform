...
public class LessonLineCircumstancesParserTest {
    ...
    public void parseCircumstaces_four_brackets_1room__2dates__1room__1room_1SinlgeDate() throws Exception {
        RoomDateBrackets rdb = new RoomDateBrackets(four_brackets_1room__2dates__1room__1room_1SinlgeDate,null,null);
        Set<Circumstance> initial = new HashSet<Circumstance>(){
            {
                ...
                circumstance.setRooms(new HashSet<Room>(){
                    {
                        Room room = new Room();
                        room.setName("ауд.358");
                        add(room);

                        room = new Room();
                        room.setName("ауд.468");
                        add(room);
                    }
                });
                circumstance.setDates(new HashSet<LocalDate>(){
                    {
                        add(LocalDate.of(2017,10,12));
                        add(LocalDate.of(2017,10,19));
                    }
                });
                add(circumstance);
                ...
                circumstance2.setRooms(new HashSet<Room>(){
                    {
                        Room room = new Room();
                        room.setName("ауд.351");
                        add(room);

                        room = new Room();
                        room.setName("ауд.222");
                        add(room);
                    }
                });
                circumstance2.setDates(new HashSet<LocalDate>(){
                    {
                        add(LocalDate.of(2017,4,1));
                    }
                });
                add(circumstance2);
            }
        ...
        Set<Circumstance> actual = rdb.parseCircumstaces();
    ...
    public void parseCircumstances_four_brackets_1room__2dates_1room_1room() throws Exception {
        RoomDateBrackets rdb = new RoomDateBrackets(four_brackets_1room__2dates_1room_1room,null,null);
        Set<Circumstance> initial = new HashSet<Circumstance>(){
            {
                Circumstance circumstance = new Circumstance();
                circumstance.setRooms(new HashSet<Room>(){
    ...
    public void parseCircumstances_single_date_single_room_one_bracket() throws Exception {
        RoomDateBrackets rdb = new RoomDateBrackets(single_date_single_room_one_bracket,null, null);
        Set<Circumstance> initial = new HashSet<Circumstance>(){
            {
                Circumstance circumstance = new Circumstance();
                circumstance.setRooms(new HashSet<Room>(){
